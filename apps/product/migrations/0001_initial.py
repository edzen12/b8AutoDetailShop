# Generated by Django 6.0.2 on 2026-02-18 12:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='product.category', verbose_name='Родитель')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
